...
var buoy_scene = preload("res://singleplayer_objects/item_buoy/item_buoy.tscn")
...
var spawnables = [
	{ weight = 10, scene = preload("res://singleplayer_objects/raft_objects/water_bucket.tscn") },
	{ weight = 40, scene = preload("res://singleplayer_objects/raft_objects/driftwood.tscn") },
	#{ weight = 15.0, scene = preload("res://singleplayer_objects/raft_objects/bomb.tscn") },
	{ weight = 5, scene = preload("res://singleplayer_objects/raft_objects/gem.tscn") },
	{ weight = 10, scene = preload("res://singleplayer_objects/raft_objects/hammer.tscn") },
	{ weight = 20, scene = preload("res://singleplayer_objects/raft_objects/cannon.tscn") },
]
