extends "res://singleplayer_objects/character/character.gd"
...
func _player_special_process(_delta):
	if Input.is_action_just_pressed("debug_1"):
		held_object = preload("res://singleplayer_objects/raft_objects/water_bucket.tscn").instantiate()
		state_machine.goto("Holding")
	
	if Input.is_action_just_pressed("debug_2"):
		held_object = preload("res://singleplayer_objects/raft_objects/driftwood.tscn").instantiate()
		state_machine.goto("Holding")
	
	if Input.is_action_just_pressed("debug_3"):
		held_object = preload("res://singleplayer_objects/raft_objects/bomb.tscn").instantiate()
		state_machine.goto("Holding")
	
	if Input.is_action_just_pressed("debug_4"):
		held_object = preload("res://singleplayer_objects/raft_objects/gem.tscn").instantiate()
		state_machine.goto("Holding")
	
	if Input.is_action_just_pressed("debug_5"):
		held_object = preload("res://singleplayer_objects/raft_objects/cannon.tscn").instantiate()
		state_machine.goto("Holding")
	
	if Input.is_action_just_pressed("debug_6"):
		held_object = preload("res://singleplayer_objects/raft_objects/hammer.tscn").instantiate()
		state_machine.goto("Holding")
